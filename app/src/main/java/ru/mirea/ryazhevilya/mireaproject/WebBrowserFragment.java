...
import ru.mirea.ryazhevilya.mireaproject.databinding.FragmentWebBrowserBinding;
...
public class WebBrowserFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = FragmentWebBrowserBinding.inflate(getLayoutInflater());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.webView.loadUrl("https://yandex.ru/yaintern");
